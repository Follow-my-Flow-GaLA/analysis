...
# run "ls -la --full-time -U ${PREFIX}crawl > ./name_list.list" in the sanchecker folder before running this file
# from target_list import result_site_dict
import os, re
from tqdm import tqdm
EXTRACT_SITES_REG = r"(.*_)\d*?_\d*?_\d"
DB_PATH = "/media/datak/inactive/sanchecker"
PREFIX = "validate_nonxss_phase3_db_" # "oracle_1M_phase2_db_" #"detector_1M_phase3_db_"
