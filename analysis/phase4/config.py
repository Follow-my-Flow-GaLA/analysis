...
class CONFIG:    
    PHASE3_JS_INFO_JSON_PATH = "/media/datak/inactive/analysis/phase3/output/phase3_info.json"
    PHASE4_RECORD_PATH = "/media/datak/inactive/sanchecker/record_inactive_notemplate_phase4_iter1_partial_crawl"
    PHASE4_LOG_PATH = "/media/datak/inactive/sanchecker/src/inactive_notemplate_phase4_iter1_partial_logs/"
