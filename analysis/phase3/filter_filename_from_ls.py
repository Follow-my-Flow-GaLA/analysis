...
# run "ls -la --full-time -U <TARGET_STR>_crawl > /media/datak/inactive/sanchecker/name_list.list" in the sanchecker folder before running this file
# from target_list import result_site_dict
import os, re
from tqdm import tqdm
EXTRACT_SITES_REG = r"(.*_)\d*?_\d*?_\d"
DB_PATH = "/media/datak/inactive/sanchecker"
PREFIX = "inactive_notemplate_phase3_iter2_partial_"
