...
'''
    def __init__(self, site='google.com', log_path=None, error_logger=None, long_data_logger=None):
        ...
        self.phase1_db = self.client["phase1"]
        self.phase3_db = self.client["phase3"]
        self.phase3_undef_prop_dataset_collection = self.phase3_db["undef_prop_dataset"]
        self.phase3_info_collection = self.phase3_db["phase_info"]
        self.code_hash_dataset_collection = self.phase1_db["code_hash_dataset"]
    ...
    def add_undef_prop_dataset_to_db(self):
        for code_hash, in_memory_key_dict in self.undef_prop_dataset.items():
            ...
            try: 
                self.phase3_undef_prop_dataset_collection.update_one(
                    {"_id": code_hash},
                    {"$setOnInsert": {
    ...
    def add_phase_info_to_db(self):
        try: 
            self.phase3_info_collection.update_one(
