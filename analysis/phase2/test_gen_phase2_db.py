...
SITE = "yuanshen_com"
RECORD_PATH = "/media/datak/inactive/sanchecker/record_detector_1M_phase3_db_crawl/record_yuanshen_com_19358_1713476968373_0" # "/media/datak/inactive/analysis/phase2/test_phase2_db_log/record"
LOG_PATH = "/media/datak/inactive/sanchecker/src/detector_1M_phase3_db_logs/yuanshen_com_log_file" # "/media/datak/inactive/analysis/phase2/test_phase2_db_log/log"
...
def get_phase2_dict(site, sink_val_list, flow_found_dict):
    ...
    global not_found_flow_site, not_found_web_site, not_found_flow_value
...
def send_post_request(site, phase_2_dict):
...
if __name__ == "__main__":
    ...
    # read log file 
    phase_2_dict = get_phase2_dict(site, sink_val_list, flow_found_dict)
    
    # count not found flows
    count = 0
    for payload, found in flow_found_dict.items():
        if not found:
            count = count + 1
    print(count)
    print(len(flow_found_dict)-count)
    
    # store in db
    send_post_request(site, phase_2_dict)
    print("---------------------------------")
