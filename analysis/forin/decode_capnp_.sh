#!/bin/bash
# To run: cd /media/datak/inactive/sanchecker; sudo bash /media/datak/inactive/analysis/forin/decode_capnp_.sh

PREFIX="record_"
ROOT="/media/datak/inactive/sanchecker/"
TARGET_STR="oracle_forin_test_" 
...
done < <(grep . ${ROOT}'list_to_capnp_'${TARGET_STR})  
