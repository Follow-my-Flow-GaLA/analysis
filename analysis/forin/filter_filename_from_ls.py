...
# run "ls -la --full-time -U oracle_forin_test_crawl > /media/datak/inactive/sanchecker/name_list.list" in the sanchecker folder before running this file
# from target_list import result_site_dict
import os, re
from tqdm import tqdm
EXTRACT_SITES_REG = r"(.*_)\d*?_\d*?_\d"
DB_PATH = "/media/datak/inactive/sanchecker"
PREFIX = "oracle_forin_test_"
